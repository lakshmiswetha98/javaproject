...
public class StudentRestController {
	...
	public ResponseEntity<Product> getById(@PathVariable Integer studentId) {
		...
		Product product = this.productService.findStudentById(studentId);
		if(product == null)
			throw new ProductNotFoundException("Student with id-" + studentId + " not Found");
	...
	public ResponseEntity<Product> save(@RequestBody Product product) {
		if(!this.productService.addStudent(product))
	...
	public ResponseEntity<Product> saveUpdate(@RequestBody Product product) {
		if(!this.productService.updateStudent(product))
	...
	public ResponseEntity<Product> delete(@PathVariable Integer studentId) {
